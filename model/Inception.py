"""
@author: pgj
@time: 2020/9/30 3:38 下午
@usage: InceptionV3 网络
"""
...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
        ...
        self.mushroom_classifier = nn.Linear(2048, num_classes)
        if init_weights:
...
class InceptionAux(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, conv_block=None):
        ...
        self.mushroom_fc = nn.Linear(768, num_classes)
        self.mushroom_fc.stddev = 0.001
